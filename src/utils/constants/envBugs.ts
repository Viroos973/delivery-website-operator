...
export const APPOINT_RESPONSIBLE_OPERATOR = import.meta.env.VITE_APPOINT_RESPONSIBLE_OPERATOR === "true";
...
export const MIXED_BUTTONS_AVAILABLE_DISHES = import.meta.env.VITE_MIXED_BUTTONS_AVAILABLE_DISHES === "true";
export const NOT_CHANGE_ORDER_STATUS = import.meta.env.VITE_NOT_CHANGE_ORDER_STATUS === "true";
export const CHANGE_ORDER_STATUS = import.meta.env.VITE_CHANGE_ORDER_STATUS_IN_HISTORY === "true";
